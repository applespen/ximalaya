...
- (void)setTrackList:(RCTrackList *)trackList{
    ...
    [self.iconView sd_setImageWithURL:[NSURL URLWithString:trackList.coverSmall] placeholderImage:[UIImage imageNamed:@"findsection_sound_bg"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
